(function(){//closure
	var app=angular.module('PersonalWebsite',['pascalprecht.translate',"ngRoute"]).config(function($translateProvider){
          ...
          NAVBAR_CV: 'RESUME',
    			...
    			WELCOME: 'Welcome',
    			GENERAL: "Hello ! My name is Quentin, I'm 24, French and I work at Apple. This website is aimed at introducing myself as well as presenting the main projects I've been working on over the last few years. ",
          ...
          CV_PIC:"<a class='cveffect' target='blank' href='pdf/Keunebroek_Quentin_resume.pdf'><img src='images/Keunebroek_Quentin_resume.png' width='400px'/></a>",
  			  ...
  			  .translations('fr', {
  			 	...
  			 	NAVBAR_CONTACT: 'CONTACT',
  			 	WELCOME: 'Bienvenue',
    			GENERAL: "Bonjour ! Je m'appelle Quentin, j'ai 24 ans et je travaille chez Apple. Ce site a pour objectifs de me présenter ainsi que faire découvrir les principaux projets auxquels j'ai participé ces dernières années.",
