(function(){//closure
	var app=angular.module('PersonalWebsite',['pascalprecht.translate',"ngRoute"]).config(function($translateProvider){
          ...
          NAVBAR_CV: 'Resume',
    			...
    			WELCOME: 'Welcome',
    			GENERAL: "Hello ! My name is Quentin Keunebroek and I'm a 22-year-old French Engineer Student at the <a target='blank' href='http://www.utc.fr/the_university/index.php'>University of Technology of Compiègne</a>. This website is aimed at introducing myself as well as presenting the main projects I've been working on over the last few years.",
    			STUDIES: "I'm currently doing a Master's degree in Computer Science. I also have a Bachelor's degree in both Engineering and Human Sciences, called <a target='blank' href='http://www.utc.fr/en/courses-and-training/the-utc-engineering-diploma/humanities-and-technology-course-hutech.html'>Humanities and Technology</a>, is aimed at better understanding the human, economic and environmental stakes of current technologies. Indeed, I'm passionate about everything relating to technologies, and especially about the way that technologies and societies interact. Finally, I did a 6-months internship as a Software Engineer at <a target='blank' href='http://www.apple.com/ '>Apple, Inc.</a> in Cupertino (California) in 2015, which was certainly the best experience I've ever had. I'm now looking for another 6-months internship starting February 2017 and a full-time job !",
